...
# Kullanıcıdan git bilgilerini al
read -p "Git kullanıcı adınızı girin: " git_username
read -p "Git e-posta adresinizi girin: " git_email
...
# AnyDesk
wget -qO - https://keys.anydesk.com/repos/DEB-GPG-KEY | sudo gpg --dearmor | sudo tee /usr/share/keyrings/anydesk.gpg
...
# Spotify
curl -sS https://download.spotify.com/debian/pubkey_6224F9941A8AA6D1.gpg | sudo gpg --dearmor -o /usr/share/keyrings/spotify.gpg
...
# Chrome
wget -qO - https://dl.google.com/linux/linux_signing_key.pub | sudo gpg --dearmor -o /usr/share/keyrings/chrome-keyring.gpg 
...
sudo apt install google-chrome-stable virtualbox-7.0 spotify-client anydesk sublime-merge code docker-ce docker-ce-cli containerd.io docker-buildx-plugin docker-compose-plugin syncthing -y
